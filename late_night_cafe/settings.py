"""
Django settings for late_night_cafe project.
...
ALLOWED_HOSTS = [
    ...
    'herokuapp.com',
    'late-night-cafe-353782271257.herokuapp.com',
    ]
...
ROOT_URLCONF = 'late_night_cafe.urls'
...
WSGI_APPLICATION = 'late_night_cafe.wsgi.application'
...
# Tells Django that we are not using email verification
