...
class Booking(models.Model):
    ...
    booking_created_at = models.DateTimeField(auto_now_add=True, default=timezone.now) # Adds UK date & time booking was first made, can't be changed
    booking_updated_at = models.DateTimeField(auto_now=True, default=timezone.now) # Adds UK date & time booking was amened, can be changed